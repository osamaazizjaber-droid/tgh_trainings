...
export const exportStudentTestPdf = async (student, training, questions, answers) => {
  ...
  // ─── Font stack (Google Fonts injected inline via @import) ──────────
  const fontImport = `@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&family=Lora:wght@600;700&display=swap');`;
        ...
        q.choices.map(c => {
          ...
          return `
            <div style="display:flex; flex-direction:column; gap:3px; padding:9px 13px; border-radius:9px;
                        border:1.5px solid ${border}; background:${bg}; color:${color}; font-family:'Plus Jakarta Sans',sans-serif;">
        ...
        <td style="padding:22px 18px; vertical-align:top; width:55%;" dir="auto">
          <div style="display:flex; align-items:center; gap:8px; margin-bottom:10px;">
            <span style="background:${C.primary}; color:#fff; font-size:9px; font-weight:900;
              ...
              letter-spacing:.07em; font-family:'Plus Jakarta Sans',sans-serif;">
              ${isMCQ ? 'MCQ' : 'OPEN'}
            </span>
          ...
          ${!isMCQ && ans
            ? `<div style="margin-top:14px; padding:13px 15px; background:#f8f7f6;
                ...
                <div style="font-size:9.5px; font-weight:800; color:${C.subtle};
                  ...
                  font-family:'Plus Jakarta Sans',sans-serif;">Participant Response</div>
                <div style="font-size:12px; font-weight:600; color:${C.text};
                  font-family:'Plus Jakarta Sans',sans-serif; line-height:1.6;">${ans.answer_text}</div>
              </div>`
            : ''}
        </td>
        ...
        <td style="padding:22px 12px; vertical-align:top; text-align:center; width:22%;">
          <div style="display:inline-flex; flex-direction:column; align-items:center; gap:8px; margin-top:6px;">
            <div style="width:42px; height:42px; border-radius:50%;
              ...
              font-size:19px; font-weight:800; box-shadow:0 2px 8px ${statusColor}22;">
              ${statusIcon}
            </div>
  ...
  const scoreBadge = (score, max, pct) => {
    ...
    return `
      ...
      <div style="font-size:11px; font-weight:700; color:${C.subtle};
        font-family:'Plus Jakarta Sans',sans-serif; margin-top:2px;">${pct}%</div>`;
  };

  // ─── Build full HTML container ────────────────────────────────────────
  ...
  container.innerHTML = `
      ...
      <div style="display:flex; align-items:center; gap:20px;">
        ...
        <div>
          ...
          <h2 style="margin:5px 0 0; font-size:14px; color:${C.accent}; font-weight:600;
            font-family:'Plus Jakarta Sans',sans-serif;" dir="auto">
            ${training.title}
          </h2>
        </div>
      </div>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:14px;
      ...
      padding:20px 24px; margin-bottom:28px; box-shadow:0 1px 4px rgba(0,0,0,.06);">
      <div>
        <div style="font-size:9.5px; font-weight:800; color:${C.subtle};
          text-transform:uppercase; letter-spacing:.08em; margin-bottom:5px;
          font-family:'Plus Jakarta Sans',sans-serif;">Student Name</div>
        <div style="font-size:15px; font-weight:700; color:${C.text};
          font-family:'Plus Jakarta Sans',sans-serif;" dir="auto">${student.user_name}</div>
      </div>
      <div>
        <div style="font-size:9.5px; font-weight:800; color:${C.subtle};
          text-transform:uppercase; letter-spacing:.08em; margin-bottom:5px;
          font-family:'Plus Jakarta Sans',sans-serif;">Phone</div>
        <div style="font-size:15px; font-weight:600; color:${C.textLight};
          font-family:'Plus Jakarta Sans',sans-serif;">${student.phone}</div>
      </div>
      <div>
        <div style="font-size:9.5px; font-weight:800; color:${C.subtle};
          text-transform:uppercase; letter-spacing:.08em; margin-bottom:6px;
          font-family:'Plus Jakarta Sans',sans-serif;">Pre-Test Score</div>
        ${scoreBadge(student.pre_score, student.pre_max, prePct)}
      </div>
      <div>
        <div style="font-size:9.5px; font-weight:800; color:${C.subtle};
          text-transform:uppercase; letter-spacing:.08em; margin-bottom:6px;
          font-family:'Plus Jakarta Sans',sans-serif;">Post-Test Score</div>
      ...
      <thead>
        <tr style="background:${C.accent}; color:#fff; border-bottom:3px solid ${C.primary};">
          <th style="padding:15px 18px; text-align:left; font-size:10.5px; width:55%;
            ...
            font-family:'Plus Jakarta Sans',sans-serif;">Question &amp; Feedback</th>
          <th style="padding:15px 12px; text-align:center; font-size:10.5px; width:22%;
            text-transform:uppercase; letter-spacing:.08em; font-weight:800;
            font-family:'Plus Jakarta Sans',sans-serif;">Status</th>
          <th style="padding:15px 18px; text-align:right; font-size:10.5px; width:23%;
            text-transform:uppercase; letter-spacing:.08em; font-weight:800;
            font-family:'Plus Jakarta Sans',sans-serif;">Score</th>
        </tr>
      </thead>
      <tbody>${rows}</tbody>
    </table>
    ...
    <div style="margin-top:24px; padding-top:16px; border-top:1px solid ${C.border};
      ...
      <div style="font-size:10px; color:${C.subtle}; font-family:'Plus Jakarta Sans',sans-serif;
        font-weight:500;">
